<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?= base_url('admin/dashboard'); ?>"><img src="<?= base_url('assets/img/logo-panjatek.png')?>" class="" style="width:30px;" alt="">  SMK PANJATEK </a>
